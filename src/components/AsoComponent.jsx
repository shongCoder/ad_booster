    ...
    return (
        <div className="lg:mt-20 md-[3.5rem]">
            <div className="w-full flex flex-col justify-center items-center md:py-[6.25rem] py-10 md:px-8 px-5">
                ...
                >
                    <div className="flex md:justify-between md:flex-row flex-col md:items-end items-start">
                        <div>
                            <p className="text-adb_blue lg:text-[1rem] md:text-[0.8125rem] font-extrabold tracking-widest">
                                ASO
                            </p>
                            <div className="font-bold lg:text-[2.25rem] md:text-[1.5rem] text-adb_black mt-5">
                                <p>
                                    앱 스토어 최적화
                                </p>
                            </div>
            ...
            <div className="w-full flex flex-col justify-center items-center md:pt-[6.25rem] pt-10 md:px-8 px-5">
                <div className="lg:w-[70rem] md:w-full w-full border border-adb_gray p-5 rounded-[1rem]">
                    <div className="flex lg:gap-5 md:gap-3">
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] lg:py-10 md:py-6 lg:px-5 md:px-3">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="lg:text-[1.25rem] md:text-[0.875rem] text-[0.875rem] font-bold">Main Keywords</span>
                                </div>
                                <div className="text-adb_text text-center font-medium lg:text-[0.8125rem] md:text-[0.6875rem] h-8">
                                    "소개팅", "채팅", "운세", "금융"
                                </div>
                            </div>
                            <div className="w-full lg:mt-10 md:mt-5 mb-3">
                                <p className="text-adb_black lg:text-[1.5rem] md:text-[0.875rem] font-bold">&#8361;500,000 ~ 1,000,000 <span className="text-adb_text lg:text-[1.125rem] md:text-[0.625rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text lg:text-[0.875rem] md:text-[0.625rem]">
                        ...
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] lg:py-10 md:py-6 lg:px-5 md:px-3">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="lg:text-[1.25rem] md:text-[0.875rem] font-bold">Sub Keywords</span>
                                </div>
                                <div className="text-adb_text text-center font-medium lg:text-[0.8125rem] md:text-[0.6875rem] h-8">
                            ...
                            <div className="w-full lg:mt-10 md:mt-5 mb-3">
                                <p className="text-adb_black lg:text-[1.5rem] md:text-[0.875rem] font-bold">&#8361;300,000 ~ 500,000 <span className="text-adb_text lg:text-[1.125rem] md:text-[0.625rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text lg:text-[0.875rem] md:text-[0.625rem]">
                        ...
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] lg:py-10 md:py-6 lg:px-5 md:px-3">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="lg:text-[1.25rem] md:text-[0.875rem] font-bold">Long-tail Keywords</span>
                                </div>
                                <div className="text-adb_text text-center font-medium lg:text-[0.8125rem] md:text-[0.6875rem] h-8">
                            ...
                            <div className="w-full lg:mt-10 md:mt-5 mb-3">
                                <p className="text-adb_black lg:text-[1.5rem] md:text-[0.875rem] font-bold">&#8361;100,000 ~ 300,000 <span className="text-adb_text lg:text-[1.125rem] md:text-[0.625rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text lg:text-[0.875rem] md:text-[0.625rem]">
                    ...
                    <div className="w-full border border-[#1956FE0A] bg-[#1956FE05] p-5 rounded-[1rem] flex gap-3 items-start mt-10">
                        ...
                        <p className="lg:text-[0.875rem] md:text-[0.75rem] text-adb_text">
            ...
            <div className="flex justify-center items-center lg:p-0 md:px-8 px-5 mt-[3.75rem] mb-[6.25rem]">
                <div className="w-[70rem] h-[13rem] bg-[#1C1F33] md:rounded-[2.5rem] rounded-[1.5rem] lg:p-[3.75rem] md:p-10 flex lg:justify-between lg:flex-row md:flex-row flex-col md:justify-between justify-center items-center">
                    <div className="lg:text-[1.75rem] md:text-[1.125rem] text-[1.125rem] font-bold text-adb_white">
                    ...
                    <div className="">
                        <a href="https://t.me/AD_Crack" target="_blank" rel="noopener noreferrer">
                            <button className="py-4 md:px-10 px-0 bg-adb_blue hover:bg-abd_blue_hover text-adb_white rounded-[2rem] shadow-[inset_4px_4px_14px_0_rgba(255,255,255,0.2)] lg:mt-0 md:mt-0 mt-5">
                                상담 문의
                            </button>
                        </a>
                    </div>

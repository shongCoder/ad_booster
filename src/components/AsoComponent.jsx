    ...
    return (
        <div className="lg:mt-20 md-[3.5rem]">
            ...
            <div className="w-full flex flex-col justify-center items-center md:pt-[6.25rem] pt-10 md:px-8 px-5">
                <div className="lg:w-[70rem] md:w-full w-full border border-adb_gray p-5 rounded-[1rem]">
                    <div className="flex gap-5">
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] py-10 px-5">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="text-[1.25rem] font-bold">Main Keywords</span>
                                </div>
                                <div className="text-adb_text font-medium text-[0.8125rem]">
                                    "소개팅", "채팅", "운세", "금융"
                                </div>
                            </div>
                            <div className="w-full mt-10 mb-3">
                                <p className="text-adb_black text-[1.5rem] font-bold">&#8361;500,000 ~ 1,000,000 <span className="text-adb_text text-[1.125rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text text-[0.875rem]">
                        ...
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] py-10 px-5">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="text-[1.25rem] font-bold">Sub Keywords</span>
                                </div>
                                <div className="text-adb_text font-medium text-[0.8125rem]">
                            ...
                            <div className="w-full mt-10 mb-3">
                                <p className="text-adb_black text-[1.5rem] font-bold">&#8361;300,000 ~ 500,000 <span className="text-adb_text text-[1.125rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text text-[0.875rem]">
                        ...
                        <div className="flex-1 border border-adb_gray rounded-[0.75rem] py-10 px-5">
                            <div className="flex justify-center items-center flex-col gap-3">
                                <div className="flex gap-1">
                                    <img src="./img/aso/sparkles.png" />
                                    <span className="text-[1.25rem] font-bold">Long-tail Keywords</span>
                                </div>
                                <div className="text-adb_text font-medium text-[0.8125rem]">
                            ...
                            <div className="w-full mt-10 mb-3">
                                <p className="text-adb_black text-[1.5rem] font-bold">&#8361;100,000 ~ 300,000 <span className="text-adb_text text-[1.125rem]">/월</span></p>
                            </div>
                            <div>
                                <ul className="text-adb_text text-[0.875rem]">
                    ...
                    <div className="w-full border border-[#1956FE0A] bg-[#1956FE05] p-5 rounded-[1rem] flex gap-3 items-start mt-10">
                        ...
                        <p className="text-[0.875rem] text-adb_text">
            ...
            <div className="flex justify-center items-center lg:p-0 md:px-8 px-5 mt-[3.75rem] mb-[6.25rem]">
                <div className="w-[70rem] h-[13rem] bg-[#1C1F33] md:rounded-[2.5rem] rounded-[1.5rem] md:px-[5rem] px-5 md:py-[3.75rem] py-6 flex lg:justify-between lg:flex-row md:flex-col flex-col md:justify-center justify-center items-center">
                    <div className="lg:text-[1.75rem] md:text-[1.5rem] text-[1.125rem] font-bold text-adb_white">
                    ...
                    <div className="lg:flex-none lg:w-fit md:w-full w-full md:flex md:justify-center md:items-center">
                        <a href="https://t.me/AD_Crack" target="_blank" rel="noopener noreferrer">
                            <button className="py-4 md:px-10 px-0 md:w-fit w-full bg-adb_blue hover:bg-abd_blue_hover text-adb_white rounded-[2rem] shadow-[inset_4px_4px_14px_0_rgba(255,255,255,0.2)] lg:mt-0 md:mt-5 mt-5">
                                상담 문의
                            </button>
                        </a>
                    </div>

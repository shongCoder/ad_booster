            ...
            <div className="lg:w-full md:w-full w-full">
                <div className="w-full h-[1400px] bg-[url('/img/main/background_img.png')] bg-cover bg-top">
                    <div className="w-full h-full bg-gradient-to-b from-gray-100 to-transparent bg-[length:100%_13%] bg-no-repeat flex justify-center items-center">
                        <div className="md:pt-10 pt-20 pb-[40rem] w-full text-center">
                            <p className="text-adb_purple mb-4 lg:text-[1rem] md:text-[0.875rem] text-[0.625rem]">
                                국내 구글스토어에 최적화된 앱 마케팅 솔루션
                            </p>
                            <p className="lg:text-[3rem] md:text-[2.75rem] text-[2rem] font-bold text-adb_black mb-2">
                                앱 상위 노출,
                            </p>
                            <p className="lg:text-[3rem] md:text-[2.75rem] text-[2rem] font-bold text-adb_black mb-2">
                                더 이상 고민하지 마세요
                ...
                <div className="w-full flex flex-col justify-center items-center md:py-[3.75rem] py-10 md:px-8 px-5">
                    ...
                    >
                        <div className="flex md:justify-between md:flex-row flex-col md:items-end items-start">
                            <div>
                                <p className="text-adb_blue lg:text-[0.875rem] md:text-[0.8125rem] text-[0.75rem] font-extrabold tracking-widest">
                                    ABOUT
                                </p>
                                <div className="font-bold lg:text-[2.25rem] md:text-[1.75rem] text-[1.5rem] text-adb_black mt-3">
                                    <p>
                                        그거 아시나요? 검색 결과가
                                    </p>
                                    <p>
                ...
                <div className="w-full flex flex-col justify-center items-center mb-20 md:px-8 px-5">
                    <div className="lg:w-[70rem] md:w-full w -full">
                        <div className="flex lg:gap-5 md:gap-4 w-full mb-5">
                            <div className="flex-1 flex justify-between flex-col lg:h-[21.25rem] md:h-[19rem] p-8 rounded-[1.25rem] bg-gradient-to-br from-[#275CFD] to-[#3A40FE] shadow-[inset_4px_4px_14px_0_rgba(255,255,255,0.2)]">
                                <p className="text-[#C8C8C8] font-play lg:text-[1rem] md:text-[0.6875rem] font-bold tracking-[0.12rem]">APP GROWTH KEYWORD</p>
                                <div className="flex justify-between items-end">
                                    <div className="text-white">
                                        <p className="lg:text-[1.5rem] md:text-[1.125rem] font-bold">앱 성공의 시작,<br/>유저 다운로드 확보</p>
                                        <p className="lg:text-[1rem] md:text-[0.75rem] text-[#C8C8C8]">높은 다운로드는 더 높은 노출로 이어집니다.<br/>애드크랙은 스토어 1위에 목표로 움직입니다.</p>
                                    </div>
                                    <div>
                            ...
                            <div className="flex-1">
                                <div className="flex lg:gap-5 md:gap-4 lg:mb-5 md:mb-4 mb-4 lg:h-[10rem] md:h-[9rem]">
                                    <div className="bg-adb_light_gray flex-1 flex flex-col justify-center items-center rounded-[1.25rem] border border-adb_gray">
                                        <p className="lg:text-[2.75rem] md:text-[2.25rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#376AFB] to-[#6822FE]">
                                            70<span className="text-[1.25rem]">%</span>
                                        </p>
                                        <p className="text-adb_black font-bold lg:text-[1rem] md:text-[0.8125rem]">앱 다운로드 중 검색 비율</p>
                                    </div>
                                    <div className="bg-adb_light_gray flex-1 flex flex-col justify-center items-center rounded-[1.25rem] border border-adb_gray">
                                        <p className="lg:text-[2.75rem] md:text-[2.25rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#376AFB] to-[#6822FE]">
                                            89<span className="text-[1.25rem]">%</span>
                                        </p>
                                        <p className="text-adb_black font-bold lg:text-[1rem] md:text-[0.8125rem]">상위 10개 플랫폼 점유율</p>
                                    </div>
                                </div>
                                <div className="bg-adb_light_gray flex-1 lg:h-[10rem] md:h-[9rem] flex flex-col justify-center items-center rounded-[1.25rem] border border-adb_gray">
                                    <p className="lg:text-[2.75rem] md:text-[2.25rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#376AFB] to-[#6822FE]">
                                        427,451<span className="text-[1.25rem]">프로젝트</span>
                                    </p>
                                    <p className="text-adb_black font-bold lg:text-[1rem] md:text-[0.8125rem]">애드부스터와 함께한 프로젝트</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex lg:gap-5 md:gap-4 w-full">
                            <div className="lg:flex-[4] md:flex-[3] flex justify-between flex-col h-[21.25rem] p-8 rounded-[1.25rem] bg-adb_light_gray border border-adb_gray">
                                <p className="text-[#8493BD] font-play lg:text-[1rem] md:text-[0.6875rem] font-bold tracking-[0.12rem]">TOP RANKING STRATEGY</p>
                                <div className="flex justify-between items-end">
                                    <div className="text-white">
                                        <p className="lg:text-[1.5rem] md:text-[1.125rem] text-adb_black font-bold">보장된 순위,<br/>검증된 키워드 전략</p>
                                        <p className="lg:text-[1rem] md:text-[0.75rem] text-[#898D99]">정밀한 키워드 전략과 함께<br/>지정 순위 달성을 정가제로 보장합니다.</p>
                                    </div>
                                    <div>
                            ...
                            <div className="lg:flex-[1] md:flex-[2] p-8 flex justify-between flex-col rounded-[1.25rem]  bg-gradient-to-br from-[#1E2948] to-[#242048] shadow-[inset_4px_4px_14px_0_rgba(255,255,255,0.2)]">
                                <p className="text-[#8493BD] font-play lg:text-[1rem] md:text-[0.6875rem] font-bold tracking-[0.12rem]">GLOBAL COVERAGE</p>
                                <div className="flex-col items-end">
                                    <div className="flex justify-center items-center">
                                        <img src="./img/main/tags.png" alt="rocket img" />
                                    </div>
                                    <div className="text-white w-full text-center">
                                        <p className="lg:text-[1.5rem] md:text-[1.125rem] text-white font-bold">글로벌 키워드 커버</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="w-full flex flex-col justify-center items-center mb-20 md:pt-[3.75rem] pt-10 md:px-8 px-5">
                    <div className="lg:w-[70rem] md:w-full w-full border border-adb_gray py-7 px-6 rounded-[1rem]">
                        <p className="lg:text-[1.5rem] md:text-[1.25rem] font-bold text-adb_purple mb-7">애드부스터 성공 케이스</p>
                        <div className="flex overflow-x-auto">
                            <div className="p-4 flex-1">
                                <div className="w-[325.33px] h-[13.75rem] mb-6">
                ...
                <div className="w-full flex flex-col justify-center items-center md:py-[3.75rem] py-10 md:px-8 px-5 bg-[url('/img/main/gradient.png')] bg-[length:100%_100%] bg-center bg-no-repeat">
                    <div className="lg:w-[70rem] md:w-full w-full">
                        <div className="font-play text-center font-black lg:text-[2.5rem] md:text-[2.25rem] text-adb_black transform scale-y-95 mb-3">
                            <p>Easily top-ranked</p>
                            <p>in App Store & Google Play</p>
                        </div>
                        <p className="text-adb_text lg:text-[1rem] md:text-[0.8125rem] text-center">App Store/Google Play의 모든 검색 결과에서 상단에 위치한 앱을 쉽게 찾을 수 있습니다.</p>
                    </div>
                    <a href="https://t.me/AD_Crack" target="_blank" rel="noopener noreferrer">
                        <button
